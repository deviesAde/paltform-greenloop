              ...
              <div class="row mb-3">
                <div class="col">
                  ...
                  <select class="form-select @error('is_published') is-invalid @enderror" name="is_published">
                    ...
                    <option value="1" {{ (old('is_published') ?? $product->is_published) == '1' ? 'selected' : '' }}>Aktif</option>
                    <option value="0" {{ (old('is_published') ?? $product->is_published) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                  </select>
                  @error('is_published')
                    <div class="invalid-feedback">
                      {{ $message }}
